                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="box">
                                        <a class="fa fa-pencil-square-o btn btn-success " href="<?php echo base_url() . 'panitia/tambahsaldodana' ?>"> Tambah data</a>
                                    </div>
                                    <div class="box-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo " $kdsaldo"; ?></td>
                                                            <td><?php echo " $kdakun5"; ?></td>
                                                            <td><?php echo " $nmsaldo"; ?></td>
                                                            <td><?php echo " $nobukti"; ?></td>
                                                            <td><?php echo " $nomsaldo"; ?></td>
