        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                <div class="container">
                  <h1>Merekam data grand program</h1>
                  <form action="<?php echo base_url() . 'panitia/tambahgrandp/simpan_data' ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="nama">Kode Grand:</label>
                      <input Type="Text" name="kdgrandp" class="form-control">
                    </div>

                    <div class="form-group">
                      <label for="nama">Nama Grand Program:</label>
                      <input Type="Text" name="nmgrandp" class="form-control">
                    </div>
                    <div class="form-group">
