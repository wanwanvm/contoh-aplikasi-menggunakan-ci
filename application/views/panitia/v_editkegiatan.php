...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
		...
		$realisasi = $pagu - $sisapagu;

    ?>
                                    <form action="<?php echo base_url() . 'panitia/tambahkegiatan/edit_data' ?>" method="post" enctype="multipart/form-data">
                                        


                                        <div class="form-group">
                                            <label for="nama">Kd Kegiatan:</label>
                                            <input Type="Text" name="kdkegiatan" value="<?php echo $kdkegiatan;?>" class="form-control">
											 <input Type="hidden" name="idkegiatan" value="<?php echo $idkegiatan ;?>" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Nama Kegiatan:</label>
                                            <input Type="Text" name="nmkegiatan" value="<?php echo "$nmkegiatan";?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="nama"> Volume </label>
                                            <input Type="Text" name="volume" id="volume" value="<?php echo "$volume";?>" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label for="nama"> Satuan </label>
                                            <input Type="Text" name="satuan" value="<?php echo "$satuan";?>" class="form-control" >
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Harga Satuan. Rp.</label>
                                            <input Type="Text" name="hargasatuan" id="hargasatuan" value="<?php echo "$hargasatuan";?>" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Total :Rp.</label>
                                            <input Type="Text" name="pagu" id="pagu" value="<?php echo "$pagu";?>" class="form-control" readonly="">
                                        </div>
										 <div class="form-group">
                                            <label for="nama">Sisa Pagu :Rp.</label>
                                            <input Type="Text" name="sisapagu" id="sisapagu" value="<?php echo "$sisapagu";?>" class="form-control" readonly="">
                                        </div>
										 <div class="form-group">
                                            <label for="nama">Realisasi :Rp.</label>
                                            <input Type="Text" name="realisasi" id="realisasi" value="<?php echo "$realisasi";?>" class="form-control" readonly="">
                                        </div>
       ...
       <script type="text/javascript">
        $(document).ready(function() {
            $("#hargasatuan, #volume").keyup(function() {
                var hargasatuan = $("#hargasatuan").val();
                var volume = $("#volume").val();

                var pagu = parseInt(hargasatuan) * parseInt(volume);
                $("#pagu").val(pagu);
            });
        });
    </script>
