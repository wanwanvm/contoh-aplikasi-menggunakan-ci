                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam data Master Akun 3</h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahlvl3/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="nama">Kode Akun Level 3:</label>
                                            <input Type="Text" name="kdakun3" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Nama Akun Level 3:</label>
                                            <input Type="Text" name="nmakun3" class="form-control">
                                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#idlvl1').change(function() {
                    var idlvl1 = $(this).val();
                    $.ajax({
                        url: "<?php echo base_url(); ?>/panitia/tambahlvl3/get_akun2",
                        method: "POST",
                        data: {
                            idlvl1: idlvl1
                        },
