    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    DATA
                    <small></small>GRAND PROGRAM
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">GRAND PROGRAM </li>
                </ol>
            </section>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    ...
                                    ?>
                                        <form action="<?php echo base_url() . 'panitia/tambahgrandp/edit_data' ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="nama">Kode Grand:</label>
                                                <input Type="Text" name="kdgrandp" value="<?php echo "$kdgrandp"; ?>" class="form-control">
                                                <input Type="hidden" name="idgrandp" value="<?php echo "$idgrandp"; ?>" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="nama">Nama Grand Program:</label>
                                                <input Type="Text" value="<?php echo "$nmgrandp"; ?>" name="nmgrandp" class="form-control">
                                            </div>
                                            <div class="form-group">
