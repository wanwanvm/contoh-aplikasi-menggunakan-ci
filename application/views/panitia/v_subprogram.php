          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <div class="box">
                    <a class="fa fa-pencil-square-o btn btn-success " href="<?php echo base_url() . 'panitia/tambahsubprogram' ?>"> Tambah data</a>
                  </div>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" bordercolor="#000000" class="table table-striped" id="example1" style="font-size:12px;">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th width="10%">kode </th>
                          <th width="75%">Nama Sub Program </th>
                          <th width="10%">Aksi </th>
                        </tr>
                      </thead>
                      <tbody>
