                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam Komponen</h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahkomponen/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="kdkomp" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Nama Komponen:</label>
                                            <input Type="Text" name="nmkomp" class="form-control">
                                        </div>
