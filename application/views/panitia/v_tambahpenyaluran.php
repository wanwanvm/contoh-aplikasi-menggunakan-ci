                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam Penyaluran </h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahpenyaluran/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="nama">Kode Transaksi:</label>
                                            <input Type="Text" name="kdsaldos" value="<?php echo "$kode"; ?>" class="form-control" readonly>
                                        </div>
										
										
                                        <div class="form-group">
                                            <label for="alamat">Kegiatan :</label>
                                            <select name="idkegiatan" id="idkegiatan" class="form-control" required>
                                                <option value="">-PILIH-</option>
                                                <?php foreach ($keg->result() as $row) : ?>
                                                    <option value="<?php echo $row->idkegiatan; ?>"><?php echo $row->kdgrandp; ?>.
                                                        <?php echo $row->kdprogram; ?>.<?php echo $row->kdsubp; ?>.<?php echo $row->kdkomp; ?>.<?php echo $row->kdkegiatan; ?> <?php echo $row->nmkegiatan; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
										  ...
										  <div class="form-group">
                                            ...
                                            <input Type="Text" name="pagu" id="pagu" value="" class="sisapagu form-control" readonly="">
                                        </div>
										  <div class="form-group">
                                            <label for="nama">Sisa pagu:</label>
                                            <input Type="Text" name="sisapagu" id="sisapagu" value="" class="sisapagu form-control" readonly="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="nmpenyaluran" class="form-control" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama">Nama Penerima:</label>
                                            <input Type="Text" name="nmpenerima" class="form-control"  required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="nama">Nominal Penyaluran:</label>
                                            <input Type="Text" name="nompenyaluran" class="form-control"  required>
                                        </div>


                                        <div class="form-group">
                                            <label for="nama">Tanggal Transaksi:</label>
                                            <input Type="Text" data-date-format="dd-mm-yyyy" name="tgltransaksi" id="tgltransaksi" class="form-control"  required>
                                        </div>
                                        <div class="form-group">
