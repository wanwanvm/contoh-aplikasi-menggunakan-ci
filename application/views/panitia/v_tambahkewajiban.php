    ...
    <div class="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam Kewajiban </h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahkewajiban/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="nmkewajiban" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="nama">Nominal Kewajiban:</label>
                                            <input Type="Text" name="nomkewajiban" class="form-control">
                                        </div>
        ...
        <?php elseif ($this->session->flashdata('msg') == 'success-hapus') : ?>
            <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Kewajiban Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
