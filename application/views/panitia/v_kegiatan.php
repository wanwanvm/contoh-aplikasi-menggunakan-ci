                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="box">
                                        <a class="fa fa-pencil-square-o btn btn-success " href="<?php echo base_url() . 'panitia/tambahkegiatan' ?>"> Tambah data</a>
                                    </div>
                                    <div class="box-body">
