...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <div class="box">
                    <a class="fa fa-pencil-square-o btn btn-success " href="<?php echo base_url() . 'panitia/tambahlvl4' ?>"> Tambah data</a>
                  </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo " $kdakun4"; ?></td>
                            <td><?php echo " $nmakun4"; ?></td>
                            <td align="center"><a class="fa fa-bars btn btn-danger" href="<?php echo base_url() . 'panitia/akunlvl4/hapus_akun?idlvl4=' ?><?php echo $idlvl4; ?>" onclick="return confirm('Yakin anda akan Hapus data akun? <?php echo $nmakun4; ?>')"> Hapus</a> | <a class="fa fa-pencil-square-o btn btn-warning" href="#" onclick="return confirm('Yakin anda akan Hapus data akun? <?php echo $nmakun1; ?>')"> Edit</a></td>
  ...
  <?php elseif ($this->session->flashdata('msg') == 'cek-akun4') : ?>
    <script type="text/javascript">
      $.toast({
        heading: 'Gagal',
        text: "Data tidak dapat di hapus kerena sudah terjadi transaksi.",
        showHideTransition: 'slide',
        icon: 'info',
        hideAfter: false,
        position: 'bottom-right',
  ...
  <?php elseif ($this->session->flashdata('msg') == 'success-hapus') : ?>
    <script type="text/javascript">
      $.toast({
        heading: 'Success',
        text: "Akun Berhasil  Berhasil dihapus.",
        showHideTransition: 'slide',
        icon: 'success',
        hideAfter: false,
        position: 'bottom-right',
