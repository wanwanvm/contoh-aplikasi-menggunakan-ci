                            ...
                            <div class="box-body">
                                <div class="container">
                                    ...
                                    <?php foreach ($data3->result_array() as $i) :
                                        ...
                                        $nmprogram = $i['nmprogram'];


                                    ?>
                                        <form action="<?php echo base_url() . 'panitia/tambahprogram/edit_data' ?>" method="post" enctype="multipart/form-data">


                                            <div class="form-group">
                                                <label for="nama">Kode Program :</label>
                                                <input Type="Text" name="kdprogram" value="<?php echo "$kdprogram"; ?>" class="form-control">
                                                <input Type="hidden" name="idprogram" value="<?php echo "$idprogram"; ?>" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="nama">Nama Program:</label>
                                                <input Type="Text" name="nmprogram" value="<?php echo "$nmprogram"; ?>" class="form-control">
                                            </div>
