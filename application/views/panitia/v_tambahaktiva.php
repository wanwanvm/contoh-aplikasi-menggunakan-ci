                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam Aktiva </h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahaktiva/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kdakun5" id="kdakun5" class="form-control">
                                                <option value="0">-PILIH-</option>
                                                <?php foreach ($data->result() as $row) : ?>
                                                    <option value="<?php echo $row->kdakun5; ?>"><?php echo $row->kdakun5; ?> <?php echo $row->nmakun5; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="nmaktiva" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="nama">Nominal Aktiva:</label>
                                            <input Type="Text" name="nomaktiva" class="form-control">
                                        </div>
