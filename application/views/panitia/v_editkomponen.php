                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    ...
                                    ?>
                                        <form action="<?php echo base_url() . 'panitia/tambahkomponen/edit_data' ?>" method="post" enctype="multipart/form-data">

                                            <div class="form-group">
                                                <label for="nama">Kd Komponen:</label>
                                                <input Type="Text" name="kdkomp" class="form-control" value="<?php echo "$kdkomp"; ?>">
                                                <input Type="hidden" name="idkomp" class="form-control" value="<?php echo "$idkomp"; ?>">
                                            </div>


                                            <div class="form-group">
                                                <label for="nama">Nama Komponen:</label>
                                                <input Type="Text" name="nmkomp" class="form-control" value="<?php echo "$nmkomp"; ?>">
                                            </div>
