                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="box">
                                        <a class="fa fa-pencil-square-o btn btn-success " href="<?php echo base_url() . 'panitia/tambahgrandp' ?>"> Tambah data</a>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo " $kdgrandp"; ?></td>

                                                        <td><?php echo " $nmgrandp"; ?></td>
