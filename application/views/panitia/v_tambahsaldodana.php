                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam Saldo Dana Awal </h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahsaldodana/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="nmsaldo" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="nama">Nominal Saldo:</label>
                                            <input Type="Text" name="nomsaldo" class="form-control">
                                        </div>
