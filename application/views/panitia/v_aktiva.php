    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    DATA
                    <small></small>AKTIVA</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">AKTIVA </li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="box">
                                        <a class="fa fa-pencil-square-o btn btn-success " href="<?php echo base_url() . 'panitia/tambahaktiva' ?>"> Tambah data</a>
                                    </div>
                                    <div class="box-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo " $kdaktiva"; ?></td>
                                                            <td><?php echo " $kdakun5"; ?></td>
                                                            <td><?php echo " $nmaktiva"; ?></td>
                                                            <td><?php echo " $nobukti"; ?></td>
                                                            <td><?php echo " $nomaktiva"; ?></td>
