                                ...
                                <div class="container">
                                    ...
                                    <form action="<?php echo base_url() . 'panitia/tambahlvl5/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="akun2" id="akun2" class="akun2 form-control">
                                                <option value="0">-PILIH-</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="akun3" id="akun3" class="akun3 form-control">
                                                <option value="0">-PILIH-</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kdakun4" id="kdakun4" class="akun4 form-control">
                                                <option value="0">-PILIH-</option>
                                            </select>
                                        </div>
