        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                <div class="container">
                  <h1>Merekam data Sub Program</h1>
                  <form action="<?php echo base_url() . 'panitia/tambahsubprogram/simpan_data' ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="alamat">Grand Program:</label>
                      <select name="grandp" id="grandp" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <input Type="Text" name="kdsubp" class="form-control">
                    </div>

                    <div class="form-group">
                      <label for="nama">Nama Sub Program:</label>
                      <input Type="Text" name="nmsubp" class="form-control">
                    </div>
