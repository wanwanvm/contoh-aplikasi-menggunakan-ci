                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam data Master Akun 2</h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahlvl2/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="kdakun2" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Nama Akun Level 2:</label>
                                            <input Type="Text" name="nmakun2" class="form-control">
                                        </div>
