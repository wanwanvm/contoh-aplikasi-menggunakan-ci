                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam Penerimaan Dana</h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahpenerimaan/simpan_data' ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="idlvl5" id="idlvl5" class="form-control">
										...
										<div class="form-group">
                                            <label for="alamat">Transaksi :</label>
                                            <select name="idtrans" id="idtrans" class="form-control">
                                                <option value="0">-PILIH-</option>
                                                <?php foreach ($data2->result() as $row2) : ?>
                                                    <option value="<?php echo $row2->idtrans; ?>"><?php echo $row2->idtrans; ?> <?php echo $row2->nmtrans; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <select name="idrek" id="idrek" class="form-control">
                                                <option value="0">-PILIH-</option>
                                                <?php foreach ($data3->result() as $row3) : ?>
                                                    <option value="<?php echo $row3->idrek; ?>"><?php echo $row3->idrek; ?> <?php echo $row3->norek; ?> <?php echo $row3->nmbank; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input Type="Text" name="nmpenerimaan" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Nomor Bukti:</label>
                                            <input Type="Text" name="nobukti" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Nominal Penerimaan:</label>
                                            <input Type="Text" name="nompenerimaan" class="form-control">
                                        </div>


                                        <div class="form-group">
                                            <label for="nama">Tanggal Buku:</label>
                                            <input Type="Text" data-date-format="dd-mm-yyyy" name="tgltransaksi" id="tgltransaksi" class="form-control">
                                        </div>
