                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="container">
                                    <h1>Merekam data Master Akun 1</h1>
                                    <form action="<?php echo base_url() . 'panitia/tambahlvl1/simpan_data' ?>" method="post" enctype="multipart/form-data">



                                        <div class="form-group">
                                            <label for="nama">Kode Akun Level 1:</label>
                                            <input Type="Text" name="kdakun1" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Nama Akun Level 1:</label>
                                            <input Type="Text" name="nmakun1" class="form-control">
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            for (i = 0; i < data.length; i++) {
                                ...
                                html += '<option value="' + data[i].kdakun3 + '">' + data[i].kdakun3 + ' ' + data[i].nmakun3 + '</option>';
                            }
                            $('.akun3').html(html);
