                    ...
                    <?php foreach ($data->result() as $row) : ?>
                        <div class="blog-single-item">
                            ...
                            <div class="blog-tiltle_block">
                                <h4><a href="<?php echo site_url('berita/' . $row->tulisan_slug); ?>"><?php echo $row->tulisan_judul; ?></a></h4>
                                ...
                                <div class="blog-icons">
                                    <div class="blog-share_block">
                                        <a href="<?php echo site_url('berita/' . $row->tulisan_slug); ?>">Baca Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="blog-featured_post">
                        ...
                        <?php foreach ($populer->result() as $row) : ?>
                            <div class="blog-featured-img_block">
                                ...
                                <h5><a href="<?php echo site_url('berita/' . $row->tulisan_slug); ?>"><?php echo limit_words($row->tulisan_judul, 3) . '...'; ?></a></h5>
