                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>0-------
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>l.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>PINA.
                        </div>
                    </div>
                    ...
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('about'); ?>">Kami</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('guru'); ?>">Pelatih & Guru</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p><?php echo date('Y'); ?> © copyright by <a href="http" target="_blank">asdaf</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="sitemap">
                        <h3>Akademik</h3>
                        <ul>
                            <li><a href="<?php echo site_url('guru'); ?>">Pelatih & Guru</a></li>
