<?php
class Tambahsaldodana extends CI_Controller
{
    ...
    function index()
    {
        ...
        $x['kode'] = $this->m_saldodana->kode();
        $x['data'] = $this->m_saldodana->get_kdakun5();
        $this->load->view('panitia/v_tambahsaldodana', $x);
    }
    ...
    function simpan_data()
    {
        ...
        $kdsaldo = $this->m_saldodana->kode();
        // $kdsaldo = $this->input->post('kdsaldo');
        $idlvl5 = $this->input->post('idlvl5');
        $nmsaldo = strip_tags($this->input->post('nmsaldo'));
        $nomsaldo = $this->input->post('nomsaldo');
        ...
        $this->m_saldodana->simpan_data($kdsaldo, $idlvl5, $nmsaldo, $nomsaldo, $nobukti, $tgltransaksi);
        echo $this->session->set_flashdata('msg', 'success');
        redirect('panitia/saldodana');
    }
